...
void BigGAN::Init() {
	...
	panel.disc_graph.SetSession(l.GetDiscriminator()); // Using discriminator for primary graph
	panel.gen_graph.SetSession(l.GetGenerator());      // Using generator for primary graph
